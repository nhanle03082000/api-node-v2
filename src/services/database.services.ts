...
const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter.asat0eg.mongodb.net/?retryWrites=true&w=majority`
// const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter.ospfr41.mongodb.net/?retryWrites=true&w=majority`
console.log('envConfig.dbUsername', envConfig.dbUsername)
console.log('envConfig.dbPassword', envConfig.dbPassword)
